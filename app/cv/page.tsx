...
export default function CVHomePage() {
  // Les 15 modèles utilisent exactement les mêmes identifiants que /cv/create.
  // Cela évite les liens vers des modèles inexistants et garantit la continuité
  // entre la page d'accueil et l'éditeur.
  const templates = [
