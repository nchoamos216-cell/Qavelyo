      ...
      <div className="max-w-md w-full bg-white/[0.03] border border-white/10 p-8 rounded-3xl space-y-6 backdrop-blur-xl relative z-10 shadow-2xl">
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <h1 className="text-2xl font-extrabold mt-2 text-white">Créer un compte</h1>
          </div>
          <p className="text-slate-400 text-xs">Rejoignez Qavelyo Link pour créer votre page</p>
        </div>
